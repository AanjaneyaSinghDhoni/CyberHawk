...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
	...
	<h1 style="color:#42aaf4"><b>Enter the FACTS<b></h1><hr>
		<form name="formdata" action="factsdata.php" method="post">
		<table>
		<tr>
			<td>
			HEADING:
...
if(isset($_POST['submit']))
{
			...
			$query=mysqli_query($connection,"INSERT INTO `factsdata`(`id`, `heading`, `body`, `author`, `image_link`, `date`) VALUES ('','$heading','$body','$author','$file','$date')");
			if($query)
			{
				echo "Data Updated";
			}
